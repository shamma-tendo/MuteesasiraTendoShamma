...
display = tk.Label(window, textvariable=display_var, font=("Arial", 48),
                    bg="black", fg="white", anchor="e", padx=20)
...
buttons = [
    ("C", 0, 0, 1, "#a5a5a5", "black", click_clear),
    ("+/-", 0, 1, 1, "#a5a5a5", "black", click_toggle_sign),
    ("DEL", 0, 2, 1, "#a5a5a5", "black", click_backspace),
    ("/", 0, 3, 1, "#ff9500", "white", lambda: click_operator("/")),
    ("7", 1, 0, 1, "#333333", "white", lambda: click_digit("7")),
    ("8", 1, 1, 1, "#333333", "white", lambda: click_digit("8")),
    ("9", 1, 2, 1, "#333333", "white", lambda: click_digit("9")),
    ("x", 1, 3, 1, "#ff9500", "white", lambda: click_operator("x")),
    ("4", 2, 0, 1, "#333333", "white", lambda: click_digit("4")),
    ("5", 2, 1, 1, "#333333", "white", lambda: click_digit("5")),
    ("6", 2, 2, 1, "#333333", "white", lambda: click_digit("6")),
    ("-", 2, 3, 1, "#ff9500", "white", lambda: click_operator("-")),
    ("1", 3, 0, 1, "#333333", "white", lambda: click_digit("1")),
    ("2", 3, 1, 1, "#333333", "white", lambda: click_digit("2")),
    ("3", 3, 2, 1, "#333333", "white", lambda: click_digit("3")),
    ("+", 3, 3, 1, "#ff9500", "white", lambda: click_operator("+")),
    ("0", 4, 0, 2, "#333333", "white", lambda: click_digit("0")),
    (".", 4, 2, 1, "#333333", "white", click_decimal),
    ("=", 4, 3, 1, "#ff9500", "white", click_equals),
]
